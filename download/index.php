				  ...
				  <ul class="nav nav-tabs">
				    ...
				    <div class="tab-content">
						<div id="installer" class="tab-pane active">
							...
							If you don't see Epsilon in the list, click on the three vertical bars on the top right, then <i>Product Catalogs</i> and check "Eclipse.org Applications". Epsilon should be near the bottom of the list (you can also use the search bar). If the <i>Product Catalogs</i> option is missing, switch to <i>Advanced Mode</i> and look for Epsilon under <i>Eclipse.org Applications</i>. Keep pressing <i>Next</i> (you don't need to change anything) and then <i>Finish</i>. Accept the licenses when prompted.
							</p>
						</div>
				    	<?if($distributions){?>
