<?php
	...
	$jars = (!$latest) and (strcmp($release["jars"], "yes") == 0);
	...
	$zippedUpdateSite = "https://www.eclipse.org/downloads/download.php?file=/epsilon/updates/".$major_release["version"]."/epsilon-".$major_release["version"]."-site.zip";
