	  ...
	  window.addEvent('domready', function(){
	    var data = {
	      ...
	      'slideshow/images/RegistryView.png': { caption: 'Explore the registered EMF EPackages' }, 
				...
				'slideshow/images/Eugenia.png': { caption: 'Generate a GMF editor from your ECore metamodel' },
				'slideshow/images/EVL.png': { caption: 'Write constraints for your ECore metamodel' },
				'slideshow/images/EVL-GMF.png': { caption: '... and see the errors/warnings in your GMF editors' },
