...
?>
	...
	<div id="rightcolumn">
		...
		<div class="sideitem">
			...
			<p>
If you're using Epsilon and are finding it useful, consider spreading the word using one or more of the options provided in this page. <br/><br/>As we all know, nothing motivates a developer to get into the trouble of installing and evaluating a tool better than other developers' recommendations.
			</p>
		</div>
