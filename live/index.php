...
<div class="row">
	...
	<div class="span8">
		...
		<div class="row">
			<div class="span8">
				<iframe src="https://epsilon-live.appspot.com/embedded.jsp?source=<?=urlencode(trim($scripts[2]->source))?>" frameborder="0" scrolling="no" style="height:600px;width:100%"></iframe>
				<h2>Live Scripts</h2>
