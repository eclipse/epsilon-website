<?php  																														require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/app.class.php");	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/nav.class.php"); 	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/menu.class.php"); 	$App 	= new App();	$Nav	= new Nav();	$Menu 	= new Menu();		include($App->getProjectCommon());    # All on the same line to unclutter the user's desktop'
	...
	<div id="midcolumn">
		...
		<!--h1><?=$pageTitle?></h1-->
					<!--h3>Welcome</h3-->
	    <img style="float:right" src="resources/epsilonlogo.big.png" alt="Epsilon Logo" /><p><b>Epsilon</b> is a family of consistent and interoperable task-specific programming languages which you can use to interact with your <a href="http://www.eclipse.org/emf">EMF</a> models to perform common Model Driven Engineering tasks such as <a href="doc/egl">code generation</a>, <a href="doc/etl">model-to-model transformation</a>, <a href="doc/evl">model validation</a>, <a href="doc/ecl">comparison</a>, <a href="doc/eml">merging</a> and <a href="doc/ewl">refactoring</a>.</p>
