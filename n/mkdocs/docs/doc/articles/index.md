...
- [Exeed annotation reference](exeed-reference): This article lists the annotations you can use on your metamodels to customize the look of the Exeed model editor.
...
- [EuGENia GMF Tutorial](eugenia-gmf-tutorial): This article provides a guide to using EuGENia for developing GMF editors, as well as its complete list of features and supported annotations.
