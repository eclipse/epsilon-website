		...
		<div class="row">
			<div class="span8">
				<ul>
					...
					<li><a href="https://bugs.eclipse.org/bugs/show_bug.cgi?id=358199">Access the domain and the notation models at the same time</a> (<a href="https://git.eclipse.org/c/epsilon/org.eclipse.epsilon.git/plain/examples/org.eclipse.epsilon.eugenia.examples.flowchart.extensions/flowchart.ewl">example</a>)
				</ul>
			</div>
		</div>
