		...
		<div class="row">
			...
			<div class="span8">
				<div class="alert alert-error alert-block">
					<b>Warning</b>: Concordance has been removed from Epsilon since version 2.0. Please consider using <a href="https://www.eclipse.org/hawk/">Eclipse Hawk</a> instead.
				</div>
