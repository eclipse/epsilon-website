...
!!! error "Regression in recent versions of Eclipse"
    The Epsilon language editors in the current stable version (2.3) [throw a null pointer exception upon initialisation](https://bugs.eclipse.org/bugs/show_bug.cgi?id=578627) when installed on versions of Eclipse after 2012-12. This has been [fixed in the latest interim version](https://git.eclipse.org/c/epsilon/org.eclipse.epsilon.git/commit/?id=7ed5f94154c1d29258aee8e16bac1d601ae65d85) of Epsilon and the fix will appear in the next stable version (2.4) shortly.
