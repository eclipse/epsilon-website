...
EOBRANDING;
	...
	$Nav->addCustomNav("View resolved bugs", "https://bugs.eclipse.org/bugs/buglist.cgi?product=gmt&component=Epsilon&cmdtype=doit&order=Reuse+same+sort+as+last+time&bug_status=RESOLVED&bug_status=VERIFIED", "_self", 1);
	$Nav->addCustomNav("View closed bugs", "https://bugs.eclipse.org/bugs/buglist.cgi?product=gmt&component=Epsilon&cmdtype=doit&order=Reuse+same+sort+as+last+time&bug_status=CLOSED", "_self", 1);
